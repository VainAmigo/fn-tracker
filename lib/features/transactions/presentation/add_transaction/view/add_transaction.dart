...
/// Состояния транзакций (список + создание)
...
/// Бизнес‑логика работы с транзакциями
    ...
    return Scaffold(
      ...
      body: BlocBuilder<TransactionsCubit, TransactionsState>(
        builder: (context, state) {
          ...
          final summaries =
              _groupTransactionsByCategory(transactions, categories);
...
List<_CategoryTransactionsSummary> _groupTransactionsByCategory(
  ...
  summaries.sort(
    (a, b) => b.lastTransactionAt.compareTo(a.lastTransactionAt),
  );
