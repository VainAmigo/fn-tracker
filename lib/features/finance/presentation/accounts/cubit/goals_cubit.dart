...
class GoalsCubit extends HydratedCubit<GoalsState> {
  ...
  Future<void> loadGoals() async {
    emit(GoalsLoading());
    try {
      final goalsModel = await financeRepo.getGoals();
  ...
  Future<void> createGoal({required GoalModel goal}) async {
    ...
    emit(GoalsLoading());
    try {
      final created = await financeRepo.createGoal(goal: goal);
  ...
  Future<void> updateGoal({required GoalModel goal}) async {
    ...
    emit(GoalsLoading());
    try {
      final updated = await financeRepo.updateGoal(goal: goal);
      final updatedList =
  ...
  Future<void> deleteGoal({
    ...
    emit(GoalsLoading());
    try {
      await financeRepo.deleteGoal(goalId, deleteTransactions: deleteTransactions);
